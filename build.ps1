...
& $APKSIGNER sign --ks $KEYSTORE --ks-pass pass:android --key-pass pass:android --ks-key-alias androiddebugkey --out VoiceAI-v1.1.0.apk build_manual\apk\aligned.apk
if ($LASTEXITCODE -ne 0) { Write-Error "Signing failed"; exit 1 }

Write-Host ""
Write-Host "SUCCESS: VoiceAI-v1.1.0.apk created!"
